...
@lazySingleton
class GetCategoryUseCase implements UseCase<CategoryModel, NoParams> {

  GetCategoryUseCase(this._storeRepository);
  final StoreRepository _storeRepository;

  @override
  Future<Either<GenericException, CategoryModel>> call(NoParams params) async =>
      _storeRepository.getAllCategory();
}
